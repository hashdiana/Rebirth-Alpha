...
public class GLSLShader {
   ...
   public GLSLShader(String fragmentShaderLocation) throws IOException {
      ...
      GL20.glAttachShader(
         program,
         this.createShader(
            "/assets/minecraft/textures/rebirth/shader/vertex/vsh/passthrough.vsh",
            GLSLShader.class.getResourceAsStream("/assets/minecraft/textures/rebirth/shader/vertex/vsh/passthrough.vsh"),
            35633
         )
      );
